...
Revision ID: 305a7085a01e
Revises: 
Create Date: 2022-08-22 17:37:26.916380
...
def upgrade():
    ...
    sa.Column('invested_amount', sa.Integer(), nullable=True),
    sa.Column('charityproject_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['charityproject_id'], ['charityproject.id'], ),
